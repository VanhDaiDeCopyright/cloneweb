require.config({
    "config": {
        "text": {
            ...
            "Magenest_CustomCheckout/template/check-login.html": "<li id=\"check_login\" data-bind=\"fadeVisible: isVisible, afterRender: afterRenderer\">\n    <div class=\"checkout-step-login\" id=\"login\">\n        <div class=\"checkout-step-title step-title-login\" data-bind=\"i18n: 'Login'\" data-role=\"title\"></div>\n\n        <div class=\"login-container\">\n            <div class=\"block  block-customer-login\">\n                <div id=\"append-form-login\" class=\"block-title\">\n                    <h3><!-- ko i18n: 'Login'--><!-- /ko --></h3>\n                    <span><!-- ko i18n: 'Log in as a Routine member'--><br><!-- /ko --><!-- ko i18n: 'to receive many attractive offers,'--><!-- /ko --></span>\n                </div>\n                <each args=\"getRegion('checkout-login-email')\" render=\"\"/>\n            </div>\n            <div class=\"block block-new-customer\">\n                <div id=\"checkout-step-title\"\n                     \n                     data-role=\"content\">\n                    <div class=\"block-title\">\n                        <h3><!-- ko i18n: 'Purchase without login'--><!-- /ko --></h3>\n                        <span><!-- ko i18n: 'Welcome! You do not need to create an account'--><!-- /ko --> <br><!-- ko i18n: 'to place an order'--><!-- /ko --></span>\n                    </div>\n\n                    <div class=\"or\"><span><!-- ko i18n: 'Or'--><!-- /ko --></span></div>\n                    <form data-bind=\"submit: navigateToNextStep\" novalidate=\"novalidate\">\n                        <div class=\"actions-toolbar\">\n                            <div class=\"primary\">\n                                <button data-role=\"opc-continue\" type=\"submit\" class=\"button action continue primary\">\n                                    <span><!-- ko i18n: 'Purchase confirmation without login'--><!-- /ko --></span>\n                                </button>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        </div>\n    </div>\n    \n    <div class=\"checkout-step-address no-active\">\n        <h2 class=\"checkout-step-title step-title-address \"><!-- ko i18n: 'Shipping address'--><!-- /ko --></h2>\n    </div>\n   \n    <div class=\"checkout-step-payment no-active\">\n        <h2 class=\"checkout-step-title step-title-payment \"><!-- ko i18n: 'Payment'--><!-- /ko --></h2>\n    </div>\n\n</li>\n",
            "Magenest_CustomCheckout/template/checkout-login-email.html": "<!-- ko ifnot: isCustomerLoggedIn -->\n\n<!-- ko foreach: getRegion('before-login-form') -->\n<!-- ko template: getTemplate() --><!-- /ko -->\n<!-- /ko -->\n<form class=\"form checkout-form-login\" data-role=\"email-with-possible-login\"\n      data-bind=\"submit:login\"\n      method=\"post\">\n    <fieldset id=\"checkout-login-email-fieldset\" class=\"fieldset\" data-bind=\"blockLoader: isLoading\">\n        <div class=\"field required\">\n            <label class=\"label\" for=\"checkout-login-email\">\n                <span data-bind=\"i18n: 'Email/ Telephone'\"></span>\n            </label>\n            <div class=\"control _with-tooltip\">\n                <input class=\"input-text\"\n                       type=\"text\"\n                       name=\"username\"\n                       data-validate=\"{required:true, 'validate-email-telephone':true}\"\n                       id=\"checkout-login-email\" />\n            </div>\n        </div>\n\n        <!--Hidden fields -->\n        <fieldset class=\"fieldset hidden-fields\" data-bind=\"fadeVisible: isPasswordVisible\">\n            <div class=\"field required\">\n                <label class=\"label\" for=\"checkout-login-password\"><span data-bind=\"i18n: 'Password'\"></span></label>\n                <div class=\"control\">\n                    <input class=\"input-text\"\n                           type=\"password\"\n                           name=\"password\"\n                           id=\"checkout-login-password\"\n                           data-validate=\"{required:true}\" autocomplete=\"off\"/>\n                    <span class=\"note\" data-bind=\"i18n: 'You already have an account with us. Sign in or continue as guest.'\"></span>\n                </div>\n\n            </div>\n            <!-- ko foreach: getRegion('additional-login-form-fields') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!-- /ko -->\n            <div class=\"actions-toolbar\">\n                <input name=\"context\" type=\"hidden\" value=\"checkout\" />\n                <div class=\"primary\">\n                    <button type=\"submit\" class=\"action login primary\" data-action=\"checkout-method-login\"><span data-bind=\"i18n: 'Login'\"></span></button>\n                </div>\n                <div class=\"secondary\">\n                    <a class=\"action remind open_modal_forgot_password_checkout\">\n                        <span data-bind=\"i18n: 'Forgot password?'\"></span>\n                    </a>\n                </div>\n            </div>\n        </fieldset>\n        <fieldset class=\"fieldset hidden-fields-button\" data-bind=\"fadeVisible : isSocialNetworkUsed\">\n            <div class=\"s-network\">\n                <span>OR</span>\n            </div>\n            <!-- ko if: isTwitterEnabled -->\n            <div class=\"modal-socialogin-email modal-twitter\"  data-bind=\"fadeVisible: isTwitterUsed,click : getTwitterUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isAmazonEnabled -->\n            <div class=\"modal-socialogin-email modal-amazon\"  data-bind=\"fadeVisible: isAmazonUsed,click : getAmazonUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isFacebookEnabled -->\n            <div class=\"modal-socialogin-email modal-facebook\"  data-bind=\"fadeVisible: isFacebookUsed,click : getFacebookUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isGoogleEnabled -->\n            <div class=\"modal-socialogin-email modal-google\"  data-bind=\"fadeVisible: isGoogleUsed,click : getGoogleUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isInstagramEnabled -->\n            <div class=\"modal-socialogin-email modal-instagram\"  data-bind=\"fadeVisible: isInstagramUsed,click : getInstagramUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isLinkedInEnabled -->\n            <div class=\"modal-socialogin-email modal-linkedin\"  data-bind=\"fadeVisible: isLinkedInUsed,click : getLinkedInUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isPinterestEnabled -->\n            <div class=\"modal-socialogin-email modal-pinterest\"  data-bind=\"fadeVisible: isPinterestUsed,click : getPinterestUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isRedditEnabled -->\n            <div class=\"modal-socialogin-email modal-reddit\"  data-bind=\"fadeVisible: isRedditUsed,click : getRedditUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isLineEnabled -->\n            <div class=\"modal-socialogin-email modal-line\"  data-bind=\"fadeVisible: isLineUsed,click : getLineUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isZaloEnabled -->\n            <div class=\"modal-socialogin-email modal-zalo\"  data-bind=\"fadeVisible: isZaloUsed,click : getZaloUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isAppleEnabled -->\n            <div class=\"modal-socialogin-email modal-apple\"  data-bind=\"fadeVisible: isAppleUsed,click : getAppleUrl\">\n            </div>\n            <!-- /ko -->\n\n        </fieldset>\n        <!--Hidden fields -->\n    </fieldset>\n</form>\n<!-- /ko -->\n",
            "Magenest_CustomCheckout/template/checkout/cart/totals/gift-card.html": "<!-- ko if: isDisplayedGiftCard() -->\n<tr class=\"totals gift_card excl\">\n    <th class=\"mark\" colspan=\"1\" scope=\"row\" data-bind=\"text: title\"></th>\n    <td class=\"amount\">\n        <span class=\"price\" data-bind=\"text: getGiftCard()\"></span>\n    </td>\n</tr>\n<!-- /ko -->\n",
            "Magenest_CustomCheckout/template/checkout/cart/totals/product-kit.html": "<!-- ko if: isDisplayedProductKitAmount() -->\n<tr class=\"totals product_kit excl\">\n    <th class=\"mark\" colspan=\"1\" scope=\"row\" data-bind=\"text: title\"></th>\n    <td class=\"amount\">\n        <span class=\"price\" data-bind=\"text: getKitAmount()\"></span>\n    </td>\n</tr>\n<!-- /ko -->\n",
            "Magenest_CustomCheckout/template/checkout/summary/gift-card.html": "<!-- ko if: isDisplayedGiftCard() -->\n<tr class=\"totals customdiscount excl\">\n    <th class=\"mark\" colspan=\"1\" scope=\"row\" data-bind=\"text: gift_card\"></th>\n    <td class=\"amount\">\n        <span class=\"price\" data-bind=\"text: getGiftCard(), attr: {'data-th': gift_card}\"></span>\n    </td>\n</tr>\n<!-- /ko -->\n",
            "Magenest_CustomCheckout/template/checkout/summary/product-kit.html": "<!-- ko if: isDisplayedProductKitAmount() -->\n<tr class=\"totals customdiscount excl\">\n    <th class=\"mark\" colspan=\"1\" scope=\"row\" data-bind=\"text: product_kit\"></th>\n    <td class=\"amount\">\n        <span class=\"price\" data-bind=\"text: getKitAmount(), attr: {'data-th': product_kit}\"></span>\n    </td>\n</tr>\n<!-- /ko -->\n",
            ...
            "Magenest_ProductLabel/template/product/list/columns/image_with_borders.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<if args=\"isAllowed()\">\n    <a if=\"imageExists($row())\"\n       class=\"product-item-photo\"\n       attr=\"href: $row().url\">\n        <span class=\"product-image-container\"\n              data-bind=\"style: {width: getWidth($row()) + 'px'}\">\n            <span class=\"product-image-wrapper\"\n                  data-bind=\"style: {'padding-bottom': getHeight($row())/getWidth($row()) * 100 + '%'}\">\n                <img class=\"product-image-photo\"\n                     data-bind=\"attr: {src: getImageUrl($row()),\n                                       alt: getLabel($row()), title: getLabel($row())}\" />\n                <div html=\"getProductLabelHtml($row())\"></div>\n            </span>\n        </span>\n    </a>\n</if>\n",
            ...
            "Magenest_OrderExtraInformation/template/form/element/vatInvoiceField.html": "<!-- input field element and corresponding bindings -->\n<input class=\"input-text\" type=\"text\" data-bind=\"\n    value: value,\n    valueUpdate: 'keyup',\n    hasFocus: focused,\n    attr: {\n        name: inputName,\n        placeholder: placeholder,\n        'aria-describedby': getDescriptionId(),\n        'aria-required': required,\n        'aria-invalid': error() ? true : 'false',\n        id: uid,\n        disabled: disabled\n    }\" aria-required=\"true\" aria-invalid=\"false\"\n       data-validate=\"{required:true, 'validate-no-html-tags':true}\">\n\n",
            "Magenest_OrderExtraInformation/template/checkout/shipping/additional-information.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<form class=\"form\">\n    <div class=\"fieldset\">\n        <each args=\"data: elems, as: 'element'\">\n            <render if=\"hasTemplate()\"/>\n        </each>\n    </div>\n</form>\n",
            "Magento_Theme/templates/breadcrumbs.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<ul class=\"items\">\n<% _.each(breadcrumbs, function(crumb) { %>\n    <li class=\"item <%- crumb.name %>\">\n        <% if (crumb.link) { %>\n        <a href=\"<%= crumb.link %>\" title=\"<%- crumb.title %>\"><%- crumb.label %></a>\n        <% } else if (crumb.last) { %>\n        <strong><%= crumb.label %></strong>\n        <% } else { %>\n        <%= crumb.label %>\n        <% } %>\n    </li>\n<% }); %>\n</ul>\n",
            "Magenest_SocialLogin/template/email.html": "<!-- ko ifnot: isCustomerLoggedIn -->\n\n<!-- ko foreach: getRegion('before-login-form') -->\n<!-- ko template: getTemplate() --><!-- /ko -->\n<!-- /ko -->\n<form class=\"form form-login\" data-role=\"email-with-possible-login\"\n      data-bind=\"submit:login\"\n      method=\"post\">\n    <fieldset id=\"checkout-shipping-email-fieldset\" class=\"fieldset\" data-bind=\"blockLoader: isLoading\">\n        <div class=\"field required\">\n            <label class=\"label\" for=\"checkout-shipping-email\">\n                <span data-bind=\"i18n: 'Email Address '\"></span>\n            </label>\n            <div class=\"control _with-tooltip\">\n                <input class=\"input-text\"\n                       type=\"email\"\n                       name=\"username\"\n                       data-validate=\"{required:true, 'validate-email':true}\"\n                       id=\"checkout-shipping-email\" />\n                </div>\n        </div>\n\n        <!--Hidden fields -->\n        <fieldset class=\"fieldset hidden-fields\" data-bind=\"fadeVisible: isPasswordVisible\">\n            <div class=\"field\">\n                <label class=\"label\" for=\"checkout-shipping-password\"><span data-bind=\"i18n: 'Password'\"></span></label>\n                <div class=\"control\">\n                    <input class=\"input-text\"\n                           data-bind=\"\n                                attr: {\n                                    placeholder: $t('Password'),\n                                }\"\n                           type=\"password\"\n                           name=\"password\"\n                           id=\"checkout-shipping-password\"\n                           data-validate=\"{required:true}\" autocomplete=\"off\"/>\n                </div>\n\n            </div>\n            <!-- ko foreach: getRegion('additional-login-form-fields') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!-- /ko -->\n            <div class=\"actions-toolbar\">\n                <input name=\"context\" type=\"hidden\" value=\"checkout\" />\n                <div class=\"primary\">\n                    <button type=\"submit\" class=\"action login primary\" data-action=\"checkout-method-login\"><span data-bind=\"i18n: 'Login'\"></span></button>\n                </div>\n                <div class=\"secondary\">\n                    <a class=\"action remind\" data-bind=\"attr: { href: forgotPasswordUrl }\">\n                        <span data-bind=\"i18n: 'Forgot password?'\"></span>\n                    </a>\n                </div>\n            </div>\n        </fieldset>\n        <fieldset class=\"fieldset hidden-fields-button\" data-bind=\"fadeVisible : isSocialNetworkUsed\">\n            <div class=\"s-network\">\n                <span>OR</span>\n            </div>\n            <!-- ko if: isTwitterEnabled -->\n            <div class=\"modal-socialogin-email modal-twitter\"  data-bind=\"fadeVisible: isTwitterUsed,click : getTwitterUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isAmazonEnabled -->\n            <div class=\"modal-socialogin-email modal-amazon\"  data-bind=\"fadeVisible: isAmazonUsed,click : getAmazonUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isFacebookEnabled -->\n            <div class=\"modal-socialogin-email modal-facebook\"  data-bind=\"fadeVisible: isFacebookUsed,click : getFacebookUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isGoogleEnabled -->\n            <div class=\"modal-socialogin-email modal-google\"  data-bind=\"fadeVisible: isGoogleUsed,click : getGoogleUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isInstagramEnabled -->\n            <div class=\"modal-socialogin-email modal-instagram\"  data-bind=\"fadeVisible: isInstagramUsed,click : getInstagramUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isLinkedInEnabled -->\n            <div class=\"modal-socialogin-email modal-linkedin\"  data-bind=\"fadeVisible: isLinkedInUsed,click : getLinkedInUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isPinterestEnabled -->\n            <div class=\"modal-socialogin-email modal-pinterest\"  data-bind=\"fadeVisible: isPinterestUsed,click : getPinterestUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isRedditEnabled -->\n            <div class=\"modal-socialogin-email modal-reddit\"  data-bind=\"fadeVisible: isRedditUsed,click : getRedditUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isLineEnabled -->\n            <div class=\"modal-socialogin-email modal-line\"  data-bind=\"fadeVisible: isLineUsed,click : getLineUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isZaloEnabled -->\n            <div class=\"modal-socialogin-email modal-zalo\"  data-bind=\"fadeVisible: isZaloUsed,click : getZaloUrl\">\n            </div>\n            <!-- /ko -->\n            <!-- ko if: isAppleEnabled -->\n            <div class=\"modal-socialogin-email modal-apple\"  data-bind=\"fadeVisible: isAppleUsed,click : getAppleUrl\">\n            </div>\n            <!-- /ko -->\n\n        </fieldset>\n        <!--Hidden fields -->\n    </fieldset>\n</form>\n<!-- /ko -->\n",
            ...
            "Magenest_SocialLogin/template/authentication.html": "<!--ko if: isButtonEnabledCheckout-->\n<div class=\"authentication-wrapper\" data-block=\"authentication\" data-bind=\"visible: isActive()\">\n    <button\n            type=\"button\"\n            class=\"action action-auth-toggle\"\n            data-trigger=\"authentication\">\n        <span data-bind=\"i18n: 'Sign In'\"></span>\n    </button>\n    <div class=\"block-authentication\"\n         style=\"display: none\"\n         data-bind=\"mageInit: {\n            'Magento_Ui/js/modal/modal':{\n                'type': 'custom',\n                'modalClass': 'authentication-dropdown',\n                'trigger': '[data-trigger=authentication]',\n                'wrapperClass': 'authentication-wrapper',\n                'parentModalClass': '_has-modal-custom _has-auth-shown',\n                'responsive': true,\n                'responsiveClass': 'custom-slide',\n                'overlayClass': 'dropdown-overlay modal-custom-overlay',\n                'buttons': []\n            }}\">\n        <!-- ko foreach: getRegion('before') -->\n        <!-- ko template: getTemplate() --><!-- /ko -->\n        <!-- /ko -->\n        <div class=\"block block-customer-login\"\n             data-bind=\"attr: {'data-label': $t('or')}\">\n            <div class=\"block-title\">\n                <strong id=\"block-customer-login-heading\"\n                        role=\"heading\"\n                        aria-level=\"2\"\n                        data-bind=\"i18n: 'Sign In'\"></strong>\n            </div>\n            <!-- ko foreach: getRegion('messages') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!--/ko-->\n            <div class=\"block-content\" aria-labelledby=\"block-customer-login-heading\">\n                <form data-role=\"login\"\n                      data-bind=\"submit:login\"\n                      method=\"post\">\n                    <div class=\"fieldset\"\n                         data-bind=\"attr: {'data-hasrequired': $t('* Required Fields')}\">\n                        <div class=\"field field-email required\">\n                            <label class=\"label\" for=\"login-email\"><span data-bind=\"i18n: 'Email address'\"></span></label>\n                            <div class=\"control\">\n                                <input type=\"email\"\n                                       class=\"input-text\"\n                                       id=\"login-email\"\n                                       name=\"username\"\n                                       data-bind=\"attr: {autocomplete: autocomplete}\"\n                                       data-validate=\"{required:true, 'validate-email':true}\" />\n                            </div>\n                        </div>\n                        <div class=\"field field-password required\">\n                            <label for=\"login-password\" class=\"label\"><span data-bind=\"i18n: 'Password'\"></span></label>\n                            <div class=\"control\">\n                                <input type=\"password\"\n                                       class=\"input-text\"\n                                       id=\"login-password\"\n                                       name=\"password\"\n                                       data-bind=\"attr: {autocomplete: autocomplete}\"\n                                       data-validate=\"{required:true}\"\n                                       autocomplete=\"off\"/>\n                            </div>\n                        </div>\n                        <!-- ko foreach: getRegion('additional-login-form-fields') -->\n                        <!-- ko template: getTemplate() --><!-- /ko -->\n                        <!-- /ko -->\n                    </div>\n                    <div class=\"actions-toolbar\">\n                        <input name=\"context\" type=\"hidden\" value=\"checkout\" />\n                        <div class=\"primary\">\n                            <br>\n                            <button type=\"submit\" class=\"action login primary\" id=\"send3\"><span data-bind=\"i18n: 'Sign In'\"></span></button>\n                        </div>\n                        <div class=\"secondary\">\n                            <a class=\"action remind\" data-bind=\"attr: {href: createNewAccount}\">\n                                <span data-bind=\"i18n: 'Create a New Account.'\"></span>\n                            </a>\n                            <br>\n                            <a class=\"action remind\" data-bind=\"attr: { href: forgotPasswordUrl }\">\n                                <span data-bind=\"i18n: 'Forgot Your Password?'\"></span>\n                            </a>\n                        </div>\n                    </div>\n                </form>\n            </div>\n        </div>\n        <!-- ko if:isButtonEnabledCheckout -->\n        <div class=\"block block-social-login\"\n             data-bind=\"attr: {'data-label': $t('or')}\">\n            <div class=\"block-title\">\n                <strong id=\"block-social-login-heading\"\n                        role=\"heading\"\n                        aria-level=\"2\"\n                        data-bind=\"i18n: 'Sign In with Social Account'\"></strong>\n            </div>\n            <div class=\"block-content\" aria-labelledby=\"block-social-account-heading\">\n                <!-- ko if: isTwitterEnabled -->\n                <div class=\"modal-authentication modal-twitter\" data-bind=\"click : getTwitterUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isFacebookEnabled -->\n                <div class=\"modal-authentication modal-facebook\" data-bind=\"click : getFacebookUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isGoogleEnabled -->\n                <div class=\"modal-authentication modal-google\" data-bind=\"click : getGoogleUrl\" ></div>\n                <!-- /ko -->\n                <!-- ko if: isAmazonEnabled -->\n                <div class=\"modal-authentication modal-amazon\" data-bind=\"click : getAmazonUrl\" ></div>\n                <!-- /ko -->\n                <!-- ko if: isLinkedInEnabled -->\n                <div class=\"modal-authentication modal-linkedin\" data-bind=\"click : getLinkedInUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isInstagramEnabled -->\n                <div class=\"modal-authentication modal-instagram\" data-bind=\"click : getInstagramUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isPinterestEnabled -->\n                <div class=\"modal-authentication modal-pinterest\" data-bind=\"click : getPinterestUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isRedditEnabled -->\n                <div class=\"modal-authentication modal-reddit\" data-bind=\"click : getRedditUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isLineEnabled -->\n                <div class=\"modal-authentication modal-line\" data-bind=\"click : getLineUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isZaloEnabled -->\n                <div class=\"modal-authentication modal-zalo\" data-bind=\"click : getZaloUrl\"></div>\n                <!-- /ko -->\n                <!-- ko if: isAppleEnabled -->\n                <div class=\"modal-authentication modal-apple\" data-bind=\"click : getAppleUrl\"></div>\n                <!-- /ko -->\n            </div>\n        </div>\n        <!-- /ko -->\n    </div>\n</div>\n<!--/ko-->\n",
            ...
            "Magento_Checkout/template/summary/totals.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n\n<div class=\"cart-summary-total cart-summary\">\n\n    <!-- ko if: isDisplayed() -->\n    <strong class=\"summary title\" data-bind=\"i18n: 'Cart Subtotal'\"></strong>\n    <div class=\"cart-totals\">\n        <table class=\"data table totals\">\n           \n            <tbody>\n            <!-- ko foreach: elems() -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!-- /ko -->\n            </tbody>\n        </table>\n    </div>\n    <!-- /ko -->\n\n    \n\n    <div class=\"actions-toolbar-trigger checkout-methods-items\" id=\"place-order-trigger-wrapper\">\n        <button type=\"button\" class=\"button action primary\" id=\"place-order-trigger\" >\n            <span data-bind=\"i18n: 'Proceed to Checkout'\"></span>\n            <span class=\"mgn-grant-total\" data-bind=\"text: getGrandTotal()\"></span>\n            <!-- ko if: (getDiscountValue() > 0) -->\n            <small>\n                <span data-bind=\"i18n: 'Save money'\"></span>\n                <span data-bind=\"text: getDiscountAmount()\"></span>\n            </small>\n            <!-- /ko -->\n        </button>\n    </div>\n\n</div>",
            "Magento_Checkout/template/summary/subtotal.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n\n<tr class=\"totals\">\n    <th class=\"mark\" scope=\"row\" data-bind=\"text: title\"></th>\n    <td class=\"amount\">\n        <span class=\"price\" data-bind =\"text: getValue(), attr:{'data-label': title}\"></span>\n        <!-- ko foreach: elems() -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n        <!-- /ko -->\n    </td>\n</tr>\n",
            "Magento_Checkout/template/summary/shipping.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<!-- ko if: quoteIsVirtual == 0 -->\n    <tr class=\"totals shipping excl\">\n        <th class=\"mark\" scope=\"row\">\n            <span class=\"label\" data-bind=\"i18n: title\"></span>\n            <span class=\"value\" data-bind=\"text: getShippingMethodTitle()\"></span>\n        </th>\n        <td class=\"amount\">\n            <!-- ko if: isCalculated() -->\n            <span class=\"price\"\n                  data-bind=\"text: getValue(), attr: {'data-th': title}\"></span>\n            <!-- /ko -->\n            <!-- ko ifnot: isCalculated() -->\n            <span class=\"not-calculated\"\n                  data-bind=\"text: getValue(), attr: {'data-th': title}\"></span>\n            <!-- /ko -->\n        </td>\n    </tr>\n<!-- /ko -->\n",
            "Magento_Checkout/template/summary/cart-items.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<div class=\"block items-in-cart\" data-bind=\"mageInit: {'collapsible':{'openedState': 'active', 'active': isItemsBlockExpanded()}}\">\n    <div class=\"title\" data-role=\"title\">\n        <strong role=\"heading\" aria-level=\"1\">\n            <translate args=\"'Product'\"/>\n        </strong>\n    </div>\n    <div class=\"content minicart-items\" data-role=\"content\">\n        <div class=\"minicart-items-wrapper\">\n            <ol class=\"minicart-items\">\n                <each args=\"items()\">\n                    <li class=\"product-item\" data-bind=\"attr: {class: $parent.getFreeGiftClass(item_id)}\">\n                        <div class=\"product\">\n                            <each args=\"$parent.elems()\" render=\"\"/>\n                        </div>\n                    </li>\n                </each>\n            </ol>\n        </div>\n    </div>\n    <div class=\"actions-toolbar\" if=\"maxCartItemsToDisplay < getCartLineItemsCount()\">\n        <div class=\"secondary\">\n            <a class=\"action viewcart\" data-bind=\"attr: {href: cartUrl}\">\n                <span data-bind=\"i18n: 'View and Edit Cart'\"></span>\n            </a>\n        </div>\n    </div>\n</div>\n<style>\n    .gift-cart-item .cart-price .price {\n        color: #646464 !important;\n        text-decoration-line: line-through;\n        font-weight: 400 !important;\n        font-size: 14px !important;\n    }\n</style>",
            "Magento_Checkout/template/summary/grand-total.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<!-- ko if: isDisplayed() -->\n<tr class=\"grand totals\">\n    <td class=\"mark\" scope=\"row\">\n        <strong data-bind=\"i18n: title\"></strong>\n    </td>\n    <td class=\"amount\" data-bind=\"attr: {'data-th': $t(title)}\">\n        <strong><span class=\"price\" data-bind=\"text: getValue()\"></span></strong>\n        <!-- ko foreach: elems() -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n        <!-- /ko -->\n    </td>\n</tr>\n<!-- /ko -->\n",
            "Magento_Checkout/template/summary/item/details.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n\n<!-- ko foreach: getRegion('before_details') -->\n    <!-- ko template: getTemplate() --><!-- /ko -->\n<!-- /ko -->\n<div class=\"product-item-details\">\n\n    <div class=\"product-item-inner\">\n        <div class=\"product-item-name-block\">\n            <strong class=\"product-item-name\" data-bind=\"html: getNameUnsanitizedHtml($parent)\"></strong>\n\n            <div class=\"product options\">\n                <!-- ko if: (JSON.parse($parent.options).length > 0)-->\n                \n                    <!--ko foreach: JSON.parse($parent.options)-->\n\n                    <dl class=\"item-options\">\n                        <dt class=\"label\" data-bind=\"text: label\"></dt>\n                        <!-- ko if: ($data.full_view)-->\n                        <!-- ko with: {full_viewUnsanitizedHtml: $data.full_view}-->\n                        <dd class=\"values\" data-bind=\"html: full_viewUnsanitizedHtml\"></dd>\n                        <!-- /ko -->\n                        <!-- /ko -->\n                        <!-- ko ifnot: ($data.full_view)-->\n                        <!-- ko with: {valueUnsanitizedHtml: $data.value}-->\n                        <dd class=\"values\" data-bind=\"html: valueUnsanitizedHtml\"></dd>\n                        <!-- /ko -->\n                        <!-- /ko -->\n\n                    </dl>\n                    <!-- /ko -->\n           \n                <!-- /ko -->\n                <div class=\"details-qty\">\n                    <span class=\"label\"><!-- ko i18n: 'SL' --><!-- /ko --></span>\n                    <span class=\"value\" data-bind=\"text: $parent.qty\"></span>\n                </div>\n            </div>\n        </div>\n        <!-- ko foreach: getRegion('after_details') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n        <!-- /ko -->\n    </div>\n    <!-- ko foreach: getRegion('item_message') -->\n        <!-- ko template: getTemplate() --><!-- /ko -->\n    <!-- /ko -->\n\n    \n</div>\n",
            ...
            "Magento_Checkout/template/custom/shipping-method.html": "<div>\n    <li id=\"opc-shipping_method\"\n        class=\"checkout-shipping-method\"\n        role=\"presentation\">\n        <div class=\"checkout-shipping-method\">\n            <div class=\"step-title\"\n                 translate=\"'Shipping Methods'\"\n                 data-role=\"title\"/>\n\n            <div id=\"checkout-step-shipping_method\"\n                 class=\"step-content\"\n                 data-role=\"content\"\n                 role=\"tabpanel\"\n                 aria-hidden=\"false\">\n                <form id=\"co-shipping-method-form\"\n                      class=\"form methods-shipping\"\n                      if=\"rates().length\"\n                      novalidate=\"novalidate\">\n\n                    <render args=\"shippingMethodListTemplate\"/>\n\n                    <div id=\"onepage-checkout-shipping-method-additional-load\">\n                        <each args=\"getRegion('shippingAdditional')\" render=\"\"/>\n                    </div>\n                    <div role=\"alert\"\n                         if=\"errorValidationMessage().length\"\n                         class=\"message notice\">\n                        <span text=\"errorValidationMessage()\"/>\n                    </div>\n                </form>\n                <div class=\"no-quotes-block\"\n                     ifnot=\"rates().length > 0\"\n                     translate=\"'Sorry, no quotes are available for this order at this time'\"/>\n            </div>\n        </div>\n    </li>\n\n    <li id=\"form-note-order\">\n        <div class=\"field-note-order\">\n            <each args=\"getRegion('before-shipping-method-form')\" render=\"\"/>\n        </div>\n    </li>\n</div>",
            "Magento_Checkout/template/custom/summary.html": "<!-- ko if: isVisible() -->\n<div class=\"opc-block-summary\" data-bind=\"blockLoader: isLoading\">\n    <!-- ko foreach: elems() -->\n    <!-- ko template: getTemplate() --><!-- /ko -->\n    <!-- /ko -->\n</div>\n<!-- /ko -->\n<!-- ko if: (isShowBtn()) -->\n\n<!-- /ko -->",
            "Magento_Checkout/template/minicart/subtotal.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<div class=\"subtotal\">\n    <span class=\"label\">\n        <!-- ko i18n: 'Subtotal money' --><!-- /ko -->\n    </span>\n\n    <!-- ko foreach: elems -->\n        <!-- ko template: getTemplate() --><!-- /ko -->\n    <!-- /ko -->\n</div>\n",
            ...
            "Magento_Checkout/template/minicart/item/price-original.html": "<div class=\"price-old\">\n    <span class=\"price-wrapper\">\n        <span class=\"price-excluding-tax\">\n            <span class=\"price-wrapper minicart-price\" data-bind=\"html: price\"></span>\n        </span>\n    </span>\n</div>\n",
            "Magento_Checkout/template/minicart/item/default.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<li data-bind=\"attr: {class: free_gift_class}\" data-role=\"product-item\">\n    <div class=\"product\">\n        <!-- ko if: product_has_url -->\n        <a data-bind=\"attr: {href: product_url, title: product_name}\" tabindex=\"-1\" class=\"product-item-photo\">\n            <!-- ko foreach: $parent.getRegion('itemImage') -->\n                <!-- ko template: {name: getTemplate(), data: item.product_image} --><!-- /ko -->\n            <!-- /ko -->\n        </a>\n        <!-- /ko -->\n        <!-- ko ifnot: product_has_url -->\n        <span class=\"product-item-photo\">\n            <!-- ko foreach: $parent.getRegion('itemImage') -->\n                <!-- ko template: {name: getTemplate(), data: item.product_image} --><!-- /ko -->\n            <!-- /ko -->\n        </span>\n        <!-- /ko -->\n\n        <div class=\"product-item-details\">\n            <strong class=\"product-item-name\">\n                <!-- ko if: product_has_url -->\n                <a data-bind=\"attr: {href: product_url}, html: $parent.getProductNameUnsanitizedHtml(product_name)\"></a>\n                <!-- /ko -->\n                <!-- ko ifnot: product_has_url -->\n                    <span data-bind=\"html: $parent.getProductNameUnsanitizedHtml(product_name)\"></span>\n                <!-- /ko -->\n            </strong>\n\n            <!-- ko if: options.length -->\n            <div class=\"product options\">\n                <span class=\"toggle\"><!-- ko i18n: 'See Details' --><!-- /ko --></span>\n\n                <div class=\"content\">\n                    <strong class=\"subtitle\"><!-- ko i18n: 'Options Details' --><!-- /ko --></strong>\n\n                    <!-- ko foreach: { data: options, as: 'option' } -->\n                    <dl class=\"product options list\">\n                        <dt class=\"label\"><!-- ko text: option.label --><!-- /ko --></dt>\n                        <dd class=\"values\">\n                            <!-- ko if: Array.isArray(option.value) -->\n                                <span data-bind=\"html: $parents[1].getOptionValueUnsanitizedHtml(option.value.join('<br/>'))\"></span>\n                            <!-- /ko -->\n                            <!-- ko if: (!Array.isArray(option.value) && ['file', 'html'].includes(option.option_type)) -->\n                                <span data-bind=\"html: $parents[1].getOptionValueUnsanitizedHtml(option.value)\"></span>\n                            <!-- /ko -->\n                            <!-- ko if: (!Array.isArray(option.value) && !['file', 'html'].includes(option.option_type)) -->\n                            <span data-bind=\"text: option.value\"></span>\n                            <!-- /ko -->\n                        </dd>\n                    </dl>\n                    <!-- /ko -->\n\n                </div>\n            </div>\n            <!-- /ko -->\n\n            <div class=\"details-qty qty\">\n                <label class=\"label\" data-bind=\"i18n: 'Qty', attr: {\n                       for: 'cart-item-'+item_id+'-qty'}\"></label>\n\n                <button type=\"button\" data-bind=\"attr: {title: $t('Decrease the quantity'), 'data-cart-item': item_id, 'data-item-qty': qty}\" class=\"decreasing-qty\"><span>-</span></button>\n                <input data-bind=\"attr: {\n                       id: 'cart-item-'+item_id+'-qty',\n                       'data-cart-item': item_id,\n                       'data-item-qty': qty,\n                       'data-cart-item-id': product_sku\n                       }, value: qty\"\n                       type=\"number\"\n                       size=\"4\"\n                       class=\"item-qty cart-item-qty\">\n\n                <button type=\"button\" data-bind=\"attr: {title: $t('Increase the quantity'), 'data-cart-item': item_id, 'data-item-qty': qty}\" class=\"increasing-qty\"><span>+</span></button>\n\n                <button data-bind=\"attr: {\n                       id: 'update-cart-item-'+item_id,\n                       'data-cart-item': item_id,\n                       title: $t('Update')\n                       }\"\n                        class=\"update-cart-item\"\n                        style=\"display: none\">\n                    <span data-bind=\"i18n: 'Update'\"></span>\n                </button>\n            </div>\n\n            <div class=\"product-item-pricing\">\n                <!-- ko if: canApplyMsrp -->\n\n                <div class=\"details-map\">\n                    <span class=\"label\" data-bind=\"i18n: 'Price'\"></span>\n                    <span class=\"value\" data-bind=\"i18n: 'See price before order confirmation.'\"></span>\n                </div>\n                <!-- /ko -->\n                <!-- ko ifnot: canApplyMsrp -->\n                <!-- ko foreach: $parent.getRegion('priceOriginalSidebar') -->\n                <!-- ko template: {name: getTemplate(), data: item.product_original_price, as: 'price'} --><!-- /ko -->\n                <!-- /ko -->\n                <!-- ko foreach: $parent.getRegion('priceSidebar') -->\n                <!-- ko template: {name: getTemplate(), data: item.product_price, as: 'price'} --><!-- /ko -->\n                <!-- /ko -->\n                <!-- /ko -->\n            </div>\n\n            <div class=\"product actions\">\n                <!-- ko if: is_visible_in_site_visibility -->\n                <div class=\"primary\">\n                    <a data-bind=\"attr: {href: configure_url, title: $t('Edit item')}\" class=\"action edit\">\n                        <span data-bind=\"i18n: 'Edit'\"></span>\n                    </a>\n                </div>\n                <!-- /ko -->\n                <div class=\"secondary\">\n                    <a href=\"#\" data-bind=\"attr: {'data-cart-item': item_id, title: $t('Remove item')}\"\n                       class=\"action delete\">\n                        <span data-bind=\"i18n: 'Remove'\"></span>\n                    </a>\n                </div>\n            </div>\n            <div class=\"message notice\" if=\"$data.message\">\n                <div data-bind=\"text: $data.message\"></div>\n            </div>\n        </div>\n    </div>\n\n</li>\n<style>\n    .gift-cart-item .minicart-price .price {\n        color: #646464 !important;\n        text-decoration-line: line-through;\n        font-weight: 400 !important;\n        font-size: 14px !important;\n    }\n    #mini-cart .gift-cart-item .product-item-pricing .price-old {\n        display: none !important;\n    }\n</style>",
            ...
            "Magento_Checkout/template/shipping-address/form.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n\n\n<h3 class=\"title\"><!-- ko i18n: 'Add shipping address'--><!-- /ko --></h3>\n\n<div data-bind=\"mageInit: {'collapsible':{'openedState': 'active','collapsible':true,'active': false}}\" class=\"form-shipping-address-content\">\n     <div data-role=\"title\">\n        <h4><span><!-- ko i18n: 'ADD DELIVERY ADDRESS'--><!-- /ko --></span></h4>\n    </div>\n    <div data-role=\"content\">\n\n        <form class=\"form form-shipping-address\" id=\"co-shipping-form\" data-bind=\"attr: {'data-hasrequired': $t('* Required Fields')}\">\n               \n            <!-- ko foreach: getRegion('before-fields') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!--/ko-->\n            <div id=\"shipping-new-address-form\" class=\"fieldset address\">\n                <!-- ko foreach: getRegion('additional-fieldsets') -->\n                <!-- ko template: getTemplate() --><!-- /ko -->\n                <!--/ko-->\n                <!-- ko if: (isCustomerLoggedIn) -->\n                <div class=\"field choice shipping-save-in-address-book\" data-bind=\"visible: !isFormInline\">\n                    <input type=\"checkbox\" class=\"checkbox\" id=\"shipping-save-in-address-book\" data-bind=\"checked: saveInAddressBook\" />\n                    <label class=\"label\" for=\"shipping-save-in-address-book\">\n                        <span data-bind=\"i18n: 'Save in address book'\"></span>\n                    </label>\n                </div>\n                <!-- /ko -->\n            </div>\n            \n        </form>\n\n        <form\n              submit=\"submitShippingAddress\"\n              novalidate=\"novalidate\">\n            <div class=\"actions-toolbar\" id=\"shipping-method-buttons-container\">\n                <div class=\"primary\">\n                    <button data-role=\"opc-continue\" type=\"submit\" class=\"button action continue primary disabled\" id=\"submit-shipping-address\">\n                        <span translate=\"'Confirm delivery to this address'\" />\n                    </button>\n                </div>\n            </div>\n        </form>\n    </div>\n</div>\n\n",
            "Magento_Checkout/template/shipping-address/shipping-method-item.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<tr class=\"row\"\n    click=\"element.selectShippingMethod\">\n    <td class=\"col col-method\">\n        <input type=\"radio\"\n               class=\"radio\"\n               ifnot=\"method.error_message\"\n               ko-checked=\"element.isSelected\"\n               ko-value=\"method.carrier_code + '_' + method.method_code\"\n               attr=\"'aria-labelledby': 'label_method_' + method.method_code + '_' + method.carrier_code + ' ' + 'label_carrier_' + method.method_code + '_' + method.carrier_code,\n                    'checked': element.rates().length == 1 || element.isSelected\" />\n    </td>\n    <td class=\"col col-method\"\n        attr=\"'id': 'label_method_' + method.method_code + '_' + method.carrier_code\"\n        text=\"method.method_title\" />\n    <!-- ko ifnot: (method.error_message) -->\n    <td class=\"col col-price\">\n        <span data-bind=\"text: element.getFormattedPrice(method.base_amount)\" />\n    </td>\n    <!-- /ko -->\n</tr>\n<tr class=\"row row-error\"\n    if=\"method.error_message\">\n    <td class=\"col col-error\" colspan=\"4\">\n        <div role=\"alert\" class=\"message error\">\n            <div text=\"method.error_message\"></div>\n        </div>\n        <span class=\"no-display\">\n            <input type=\"radio\"\n                   attr=\"'value' : method.method_code, 'id': 's_method_' + method.method_code\" />\n        </span>\n    </td>\n</tr>\n",
            "Magento_Checkout/template/shipping-address/list.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n\n<!-- ko if: (visible)-->\n\n<div class=\"checkout-step-address-left\">\n    <h3><!-- ko i18n: 'Choose an address'--><!-- /ko --></h3>\n    <div class=\"field addresses\">\n        <div class=\"control\">\n            <div class=\"shipping-address-items\">\n                <!-- ko foreach: { data: elems, as: 'element' } -->\n                <!-- ko template: element.getTemplate() --><!-- /ko -->\n                <!-- /ko -->\n            </div>\n        </div>\n\n        <div class=\"actions-toolbar\">\n            <button id=\"shipping-list-address\" class=\"action primary\" data-bind=\"i18n: 'Delivery to selected address', click: selectAddress\"></button>\n        </div>\n    </div>\n</div>\n<div class=\"or\"><span><!-- ko i18n: 'Or'--><!-- /ko --></span></div>\n<!-- /ko -->\n",
            "Magento_Checkout/template/shipping-address/element/obs-telephone.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<div class=\"field\" data-bind=\"attr: {'name': element.dataScope}, css: additionalClasses, afterRender: populateTelephone\">\n\n    <label class=\"label\" data-bind=\"attr: { for: element.uid }\"><!-- ko if: element.label --><span translate=\"element.label\"></span><!-- /ko --></label>\n\n    <div class=\"control\" data-bind=\"css: {'_with-tooltip': element.tooltip}\">\n        <!-- ko ifnot: element.hasAddons() -->\n        <!-- ko template: element.elementTmpl --><!-- /ko -->\n        <!-- /ko -->\n\n        <!-- ko if: element.hasAddons() -->\n        <div class=\"control-addon\">\n            <!-- ko template: element.elementTmpl --><!-- /ko -->\n\n            <!-- ko if: element.addbefore -->\n            <label class=\"addon-prefix\" data-bind=\"attr: { for: element.uid }\"><span data-bind=\"text: element.addbefore\"></span></label>\n            <!-- /ko -->\n\n            <!-- ko if: element.addafter -->\n            <label class=\"addon-suffix\" data-bind=\"attr: { for: element.uid }\"><span data-bind=\"text: element.addafter\"></span></label>\n            <!-- /ko -->\n        </div>\n        <!-- /ko -->\n\n        <!-- ko if: element.tooltip -->\n        <!-- ko template: element.tooltipTpl --><!-- /ko -->\n        <!-- /ko -->\n\n        <!-- ko if: element.notice -->\n        <div class=\"field-note\" data-bind=\"attr: { id: element.noticeId }\">\n            <span data-bind=\"text: element.notice\"/>\n        </div>\n        <!-- /ko -->\n\n        <!-- ko if: element.error() -->\n        <div class=\"field-error\" data-bind=\"attr: { id: element.errorId }\" generated=\"true\">\n            <span data-bind=\"text: element.error\"/>\n        </div>\n        <!-- /ko -->\n\n        <!-- ko if: element.warn() -->\n        <div role=\"alert\" class=\"message warning\" data-bind=\"attr: { id: element.warningId }\" generated=\"true\">\n            <span data-bind=\"text: element.warn\"/>\n        </div>\n        <!-- /ko -->\n    </div>\n</div>\n<!-- /ko -->\n",
            ...
            "Magenest_Core/template/authentication.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<div class=\"authentication-wrapper\" data-block=\"authentication\" data-bind=\"visible: isActive()\">\n    <button\n        type=\"button\"\n        class=\"action action-auth-toggle\"\n        data-trigger=\"authentication\">\n        <span data-bind=\"i18n: 'Sign In'\"></span>\n    </button>\n    <div class=\"block-authentication\"\n         style=\"display: none\"\n         data-bind=\"mageInit: {\n            'Magento_Ui/js/modal/modal':{\n                'type': 'custom',\n                'modalClass': 'authentication-dropdown',\n                'trigger': '[data-trigger=authentication]',\n                'wrapperClass': 'authentication-wrapper',\n                'parentModalClass': '_has-modal-custom _has-auth-shown',\n                'responsive': true,\n                'responsiveClass': 'custom-slide',\n                'overlayClass': 'dropdown-overlay modal-custom-overlay',\n                'buttons': []\n            }}\">\n        <!-- ko foreach: getRegion('before') -->\n        <!-- ko template: getTemplate() --><!-- /ko -->\n        <!-- /ko -->\n        <div class=\"block block-customer-login\"\n             data-bind=\"attr: {'data-label': $t('or')}\">\n            <div class=\"block-title\">\n                <strong id=\"block-customer-login-heading\"\n                        role=\"heading\"\n                        aria-level=\"2\"\n                        data-bind=\"i18n: 'Sign In'\"></strong>\n            </div>\n            <!-- ko foreach: getRegion('messages') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!--/ko-->\n            <div class=\"block-content\" aria-labelledby=\"block-customer-login-heading\">\n                <form data-role=\"login\"\n                      data-bind=\"submit:login\"\n                      method=\"post\">\n                    <div class=\"fieldset\"\n                         data-bind=\"attr: {'data-hasrequired': $t('* Required Fields')}\">\n                        <div class=\"field field-email required\">\n                            <label class=\"label\" for=\"login-email\"><span data-bind=\"i18n: 'Email Address'\"></span></label>\n                            <div class=\"control\">\n                                <input type=\"text\"\n                                       class=\"input-text\"\n                                       id=\"login-email\"\n                                       name=\"username\"\n                                       data-bind=\"attr: {autocomplete: autocomplete}\"\n                                       data-validate=\"{required:true}\" />\n                            </div>\n                        </div>\n                        <div class=\"field field-password required\">\n                            <label for=\"login-password\" class=\"label\"><span data-bind=\"i18n: 'Password'\"></span></label>\n                            <div class=\"control\">\n                                <input type=\"password\"\n                                       class=\"input-text\"\n                                       id=\"login-password\"\n                                       name=\"password\"\n                                       data-bind=\"attr: {autocomplete: autocomplete}\"\n                                       data-validate=\"{required:true}\"\n                                       autocomplete=\"off\"/>\n                            </div>\n                        </div>\n                        <!-- ko foreach: getRegion('additional-login-form-fields') -->\n                        <!-- ko template: getTemplate() --><!-- /ko -->\n                        <!-- /ko -->\n                    </div>\n                    <div class=\"actions-toolbar\">\n                        <input name=\"context\" type=\"hidden\" value=\"checkout\" />\n                        <div class=\"primary\">\n                            <button type=\"submit\" class=\"action action-login secondary\"><span data-bind=\"i18n: 'Sign In'\"></span></button>\n                        </div>\n                        <div class=\"secondary\">\n                            <a class=\"action action-remind\" data-bind=\"attr: { href: forgotPasswordUrl }\">\n                                <span data-bind=\"i18n: 'Forgot Your Password?'\"></span>\n                            </a>\n                        </div>\n                    </div>\n                </form>\n            </div>\n        </div>\n    </div>\n</div>\n",
            "Magenest_NotificationBox/template/notification.html": "<div class=\"magenest-notification-box\">\n    <div class=\"magenest-notification-content\">\n        <div class=\"magenest-notification-header\">\n            <strong class=\"magenest-notification-title\" data-bind=\"i18n: 'Notification'\"></strong>\n            <div class=\"magenest-notification-close\"></div>\n        </div>\n        <div class=\"magenest-notification-empty\" data-bind=\"visible: visibleNotification\">\n            <span data-bind=\"i18n: 'No any notification.'\"></span>\n        </div>\n        <div class=\"magenest-notification-list\" data-bind=\"foreach: allNotification\" >\n           <div class=\"magenest-notification-item\" data-bind=\"style: { 'background-color': markAsRead },click: $parent.readNotification\">\n               <a class=\"mgn-noti-link\" data-bind=\"attr: { href: redirect_url }\">\n                   <span class=\"mgn-noti-image\"><img data-bind=\"attr: { src: icon}\"/></span>\n                   <span class=\"mgn-noti-detail\">\n                        <span class=\"mgn-noti-desc\" data-bind=\"text:description, style: {'color': markAsRead}\"></span>\n                        <span class=\"mgn-noti-created_at\" data-bind=\"text: created_at\"></span>\n                   </span>\n                    <div class=\"mgn-noti-label\" data-bind=\"visible: markAsReadIcon == true\">\n                        <span>New</span>\n                    </div>\n               </a>\n           </div>\n        </div>\n        <div class=\"magenest-notification-link\">\n            <a data-bind=\"i18n: 'View all notifications', attr: { href: urlNotificationTab }\"></a>\n        </div>\n    </div>\n</div>\n",
            "Magenest_NotificationBox/template/notificationpopup/popup.html": "<div class=\"notification-wrapper\">\n    <span class=\"close\"></span>\n    <div class=\"notification-popup\">\n        <p class=\"message\"></p>\n        <div class=\"answer-wrapper\">\n            <span class=\"defer\">Remind me later</span>\n            <button id=\"mgn-allow-receive-notice\" class=\"action tocart primary\">Allow</button>\n        </div>\n    </div>\n</div>\n",
            ...
            "Magenest_AbandonedCart/template/form/element/telephone.html": "<!-- input field element and corresponding bindings -->\r\n<input class=\"input-text\" type=\"text\" data-bind=\"\r\n    value: value,\r\n    valueUpdate: 'keyup',\r\n    hasFocus: focused,\r\n    attr: {\r\n        name: mobile_number,\r\n        placeholder: placeholder,\r\n        'aria-describedby': noticeId,\r\n        id: uid,\r\n        disabled: disabled\r\n    }, afterRender: maxMageTelephoneRenderComplete\"/>",
            ...
            "Magenest_CouponCode/template/codeList.html": "<div id=\"coupon-input-field\">\n<!-- ko if: rules -->\n<div class=\"listingScroll\" id=\"scrollbar2\">\n    <strong data-bind=\"i18n: 'Your offers'\"></strong>\n    <div class=\"listingScrollContent\">\n        <!-- ko foreach: rules -->\n        <div class=\"display-coupon-list\" data-bind=\"click: $parent.useNow, attr: {'data-code': $parent.getCouponCode($data)}\">\n            <!-- ko if: $parent.isFullBackGroundImage($data) == 0 -->\n                <!-- ko if: $parent.displayFields($data) -->\n                <strong class=\"name\" data-bind=\"text: $data.code\"></strong>\n                <div class=\"description\" data-bind=\"html: $data.name\" style=\"display: none\"></div>\n                <!-- /ko -->\n            <!-- /ko -->\n        </div>\n        <!-- /ko -->\n    </div>\n    <div class=\"coupon-description\">\n\n    </div>\n</div>\n<!-- /ko -->\n</div>\n<div data-bind=\"afterRender: afterGenerateForm();\"></div>\n",
            "Magenest_CouponCode/template/payment/discount.html": "<!--\n/**\n * Copyright \u00a9 Magento, Inc. All rights reserved.\n * See COPYING.txt for license details.\n */\n-->\n<div class=\"payment-option opc-payment-additional cart-summary-coupon\">\n    <div class=\"payment-option opc-payment-additional block discount\">\n        <div class=\"payment-option-content\" data-role=\"content\">\n            <!-- ko foreach: getRegion('couponCode') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!-- /ko -->\n        </div>\n\n        <div class=\"title block-discount-title\" data-role=\"title\">\n            <strong data-bind=\"i18n: 'ENTER OFFER COUPON CODE'\"></strong>\n        </div>\n        <div class=\"note\">\n            <span data-bind=\"i18n: 'Only use 1 code for 1 order'\"></span>\n        </div>\n\n        <!-- ko foreach: getRegion('messages') -->\n        <!-- ko template: getTemplate() --><!-- /ko -->\n        <!--/ko-->\n        <form class=\"form form-discount\" id=\"discount-form\">\n            <div class=\"payment-option-inner\">\n                <div class=\"field\">\n                    <div class=\"control\">\n                        <input class=\"input-text\"\n                               type=\"text\"\n                               id=\"discount-code\"\n                               name=\"discount_code\"\n                               data-validate=\"{'required-entry':true}\"\n                               data-bind=\"value: couponCode, attr:{disabled:isApplied() , placeholder: $t('Enter discount code')}\" />\n                    </div>\n                </div>\n            </div>\n            <div class=\"actions-toolbar\">\n                <div class=\"primary\">\n                    <!-- ko ifnot: isApplied() -->\n                    <button class=\"action action-apply\" type=\"submit\" data-bind=\"'value': $t('Apply'), click: apply\">\n                        <span><!-- ko i18n: 'Apply'--><!-- /ko --></span>\n                    </button>\n                    <!-- /ko -->\n                    <!-- ko if: isApplied() -->\n                    <button class=\"action action-cancel\" type=\"submit\" data-bind=\"'value': $t('Cancel'), click: cancel\">\n                        <span><!-- ko i18n: 'Cancel'--><!-- /ko --></span>\n                    </button>\n                    <!-- /ko -->\n                </div>\n            </div>\n            <!-- ko foreach: getRegion('captcha') -->\n            <!-- ko template: getTemplate() --><!-- /ko -->\n            <!-- /ko -->\n        </form>\n        <div class=\"checkout-coupon-description\">\n\n        </div>\n    </div>\n    <!-- ko if: isActiveTelephoneVip() -->\n    <div class=\"block discount\">\n        <div class=\"title block-discount-title\">\n            <strong role=\"heading\" data-bind=\"i18n: 'Enter vip phone number'\"></strong>\n            <span class=\"value\" data-bind=\"i18n: 'if there exists'\"></span>\n        </div>\n        <div class=\"content\" data-role=\"content\">\n            <div>\n                <a class=\"vip-policy\" data-bind=\"i18n: 'VIP customer policy', attr:{href:getVipPolicyUrl()\"></a>\n                <form method=\"post\" id=\"vip-phone-form\">\n                    <div data-role=\"checkout-messages\" class=\"messages vip-phone-error-wrapper\" style=\"display: none;\">\n                        <div aria-atomic=\"true\" role=\"alert\" class=\"message message-error error\">\n                            <div data-ui-id=\"checkout-cart-validationmessages-message-error\" class=\"vip-phone-error\"></div>\n                        </div>\n                    </div>\n                    <div data-role=\"checkout-messages\" class=\"messages vip-phone-success-wrapper\" style=\"display: none;\">\n                        <div aria-atomic=\"true\" role=\"alert\" class=\"message message-success success\">\n                            <div data-ui-id=\"checkout-cart-validationmessages-message-success\" class=\"vip-phone-success\"></div>\n                        </div>\n                    </div>\n                    <div class=\"fieldset coupon\">\n                        <div class=\"field\">\n                            <div class=\"control\">\n                                <input type=\"text\"\n                                       class=\"input-text\"\n                                       data-validate=\"{'required-entry':true, 'validate-telephone-require': true}\"\n                                       data-bind=\"value: vipPhone, attr:{disabled:isVipPhoneApplied()}\"\n                                       name=\"vip-phone\"\n                                       id=\"vip-phone\"/>\n                            </div>\n                        </div>\n                        <div class=\"actions-toolbar\">\n                            <div class=\"primary\">\n                                <!-- ko ifnot: isVipPhoneApplied() -->\n                                <button class=\"action primary\" data-bind=\"click: validateVipPhoneBeforeApply\" type=\"submit\">\n                                    <span data-bind=\"i18n: 'Apply'\"></span>\n                                </button>\n                                <!-- /ko -->\n                                <!-- ko if: isVipPhoneApplied() -->\n                                <button class=\"action cancel primary\" type=\"submit\" data-bind=\"click: cancelVipPhone\">\n                                    <span><!-- ko i18n: 'Cancel'--><!-- /ko --></span>\n                                </button>\n                                <!-- /ko -->\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"message-wrapper\" style=\"margin-top: 10px;\">\n                        <span class=\"vip-phone-result-message\" style=\"color: #D92323; font-size: 13px;\"></span>\n                    </div>\n                </form>\n                <div class=\"note note-after\" style=\"display: none\">\n                    <span data-bind=\"i18n: 'S\u0110T 0123456789 is currently a VIP Gold member of Routine. Vip Gold gets 10% off for full price products.'\"></span>\n                </div>\n            </div>\n            <div class=\"vip-phone-otp\"\n                 style=\"display: none\"\n                 data-bind=\"mageInit: {\n                    'Magenest_Otp/js/telephone-vip-otp':{\n                        'url': getSendOtpUrl(),\n                        'otpButton': '.vip-otp-sender-button',\n                        'telephone': '.vip-otp-telephone',\n                        'form': '#vip-telephone-form',\n                        'message': '.vip-otp-result-message',\n                        'isForgotPassword': 1\n                    }}\">\n                <form class=\"field-action-otp\" id=\"vip-telephone-form\">\n                    <span>Vui l\u00f2ng click <b>NH\u1eacN OTP</b> \u0111\u1ec3 x\u00e1c minh</span>\n                    <input type=\"hidden\"\n                           name=\"vip-otp-telephone\"\n                           class=\"vip-otp-telephone\"\n                           value=\"\"/>\n                    <div class=\"primary vip-otp-sender-button\">\n                        <button class=\"action primary\" type=\"button\">\n                            <span data-bind=\"i18n: 'Get OTP'\"></span>\n                        </button>\n                    </div>\n                    <div class=\"message-wrapper\" style=\"margin-top: 10px;\">\n                        <span class=\"vip-otp-result-message\" style=\"color: #D92323; font-size: 13px;\"></span>\n                    </div>\n                </form>\n                <div>\n                    <form method=\"post\" id=\"vip-phone-confirm\">\n                        <div class=\"fieldset coupon\">\n                            <div class=\"field\">\n                                <div class=\"control\">\n                                    <input type=\"hidden\" class=\"vip-otp-telephone\" name=\"telephone\" value=\"\" data-validate=\"{required:true, 'validate-telephone-require': true}\"/>\n                                    <input type=\"text\" class=\"input-text\" data-validate=\"{required:true}\" name=\"otp\"/>\n                                </div>\n                            </div>\n                            <div class=\"actions-toolbar\">\n                                <div class=\"primary\" data-bind=\"click: applyVipPhone\">\n                                    <button class=\"action primary\" type=\"submit\">\n                                        <span data-bind=\"i18n: 'Confirm'\"></span>\n                                    </button>\n                                </div>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        </div>\n    </div>\n    <!-- /ko -->\n\n    <!-- ko if: isActiveGiftCart() -->\n    <div class=\"block discount\">\n        <div class=\"title\">\n            <strong role=\"heading\" data-bind=\"i18n: 'Enter giftcard / voucher code'\"></strong>\n        </div>\n        <div class=\"content\" data-role=\"content\">\n            <div>\n                <form method=\"post\" id=\"gift_card_form\">\n                    <div class=\"fieldset discount-option\">\n                        <div class=\"field\">\n                            <div class=\"control\">\n                                <select name=\"\" id=\"\">\n                                    <option value=\"\" data-bind=\"i18n: 'Choose a discount code issuer'\"></option>\n                                </select>\n                            </div>\n                        </div>\n                        <span class=\"vip-policy\" data-bind=\"i18n: 'Multiple codes can be used, separated by commas'\"></span>\n                    </div>\n                    <div data-role=\"checkout-messages\" class=\"messages gift-card-error-wrapper\" style=\"display: none;\">\n                        <div aria-atomic=\"true\" role=\"alert\" class=\"message message-error error\">\n                            <div data-ui-id=\"checkout-cart-validationmessages-message-error\" class=\"gift-card-error\"></div>\n                        </div>\n                    </div>\n                    <div data-role=\"checkout-messages\" class=\"messages gift-card-success-wrapper\" style=\"display: none;\">\n                        <div aria-atomic=\"true\" role=\"alert\" class=\"message message-success success\">\n                            <div data-ui-id=\"checkout-cart-validationmessages-message-success\" class=\"gift-card-success\"></div>\n                        </div>\n                    </div>\n                    <div class=\"fieldset coupon\">\n                        <div class=\"field\">\n                            <div class=\"control\">\n                                <input type=\"text\"\n                                       class=\"input-text\"\n                                       id=\"gift_card_code\"\n                                       name=\"gift_card_code\"\n                                       data-validate=\"{required:true}\"\n                                       data-bind=\"value: giftCardCode, attr:{disabled:isGiftCardApplied(), placeholder: $t('Example: Voucher code 1, Voucher code 1, ...')}\"/>\n                            </div>\n                        </div>\n                        <div class=\"actions-toolbar\">\n                            <div class=\"primary\">\n                                <!-- ko ifnot: isGiftCardApplied() -->\n                                <button class=\"action apply primary\" type=\"submit\" data-bind=\"'value': $t('Apply'), click: applyGiftCard\">\n                                    <span><!-- ko i18n: 'Apply'--><!-- /ko --></span>\n                                </button>\n                                <!-- /ko -->\n                                <!-- ko if: isGiftCardApplied() -->\n                                <button class=\"action cancel primary\" type=\"submit\" data-bind=\"'value': $t('Cancel'), click: cancelGiftCard\">\n                                    <span><!-- ko i18n: 'Cancel'--><!-- /ko --></span>\n                                </button>\n                                <!-- /ko -->\n                            </div>\n                        </div>\n                    </div>\n                </form>\n            </div>\n        </div>\n    </div>\n    <!-- /ko -->\n</div>\n",
            "Magenest_CouponCode/template/checkout/minicart/coupon.html": "<div class=\"coupon-code\" data-bind=\"visible: isVisible()\">\n    <div class=\"title\">\n        <strong data-bind=\"i18n: 'Coupon code'\"></strong>\n        <span data-bind=\"i18n: '(Apply at the checkout page)'\"></span>\n    </div>\n\n    <div class=\"content\">\n        <ul class=\"counpons counpon-items\" data-bind=\"foreach: showData()\">\n            <li class=\"counpon-item\">\n                <button data-bind=\"text: $data.code, click: $parent.showDescription, attr: {'class': code}\"> </button>\n            <li>\n        </ul>\n        <span id=\"rule-description\"></span>\n    </div>\n</div>\n\n"
        }
    }
});
require.config({
